...
class FormController {
    ...
    @RequestMapping(params = ["price", "owner_name",
        ...
        "isFinish", "isPay", "time"], method = [RequestMethod.POST], value = ["/order/v1/form/add"])
    ...
    @RequestMapping(params = ["ownerName"], method = [RequestMethod.POST], value = ["/order/v1/form/all/ownername"])
    ...
    @RequestMapping(method = [RequestMethod.POST], value = ["/order/v1/form/all"])
